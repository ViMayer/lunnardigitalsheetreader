                ...
                <li key={sheet.id}>
                  ...
                  >
                    ...
                    <input
                      ...
                      placeholder={`${
                        sheet.automaticValue != 0 ? sheet.automaticValue : "=="
                      }`}
                    ...
                    <input
                      ...
                      placeholder={`${sheet.grupo != 0 ? sheet.grupo : "=="}`}
                    ...
                    <input
                      ...
                      placeholder={`${
                        sheet.parcelDetails != 0 ? sheet.parcelDetails : "=="
                      }`}
                    ...
                    <input
                      ...
                      placeholder={`${sheet.comis != 0 ? sheet.comis : "=="}`}
                    ...
                    <input
                      ...
                      placeholder={`${sheet.equipe != 0 ? sheet.equipe : "=="}`}
                    ...
                    <input
                      ...
                      placeholder={`${
                        sheet.nm_categ_comis != 0 ? sheet.nm_categ_comis : "=="
                      }`}
